...
For enum types (described in [Enumerated Types](braised:ref/datatype-enum)), there are several functions that allow cleaner programming without hard-coding particular values of an enum type.
These are listed in Enum Support Functions.
