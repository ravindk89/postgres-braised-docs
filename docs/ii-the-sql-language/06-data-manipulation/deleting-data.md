...
But you can also remove groups of rows matching a condition, or you can remove all rows in the table at once.

You use the [DELETE](braised:ref/sql-delete) command to remove rows; the syntax is very similar to the [UPDATE](braised:ref/sql-update) command.
