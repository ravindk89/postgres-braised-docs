...
:::{/item}
:::{.item term="`DROP member_object`"}
This form removes a member object from the extension. This is mainly useful in extension update scripts. The object is not dropped, only disassociated from the extension.
:::{/item}
:::{/dl}

See [Packaging Related Objects into an Extension](braised:ref/extend-extensions) for more information about these operations.
...
:::{/item}
:::{.item term="*object_name*; *aggregate_name*; *function_name*; *operator_name*; *procedure_name*; *routine_name*"}
