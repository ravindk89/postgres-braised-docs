...
Use [`ROLLBACK TO`](#sql-rollback-to) to rollback to a savepoint.
Use [`RELEASE SAVEPOINT`](#sql-release-savepoint) to destroy a savepoint, keeping the effects of commands executed after it was established.
