...
Base types and enum types (scalar types) are created with [`CREATE TYPE`](#sql-createtype), and domains with [`CREATE DOMAIN`](#sql-createdomain).
...
:::{.table}
  ...
  :::{.row}
  :::{.cell}
   typnamespace `oid` (references [pg_namespace](#catalog-pg-namespace).oid)
  ...
  :::{.row}
  :::{.cell}
   typowner `oid` (references [pg_authid](#catalog-pg-authid).oid)
  ...
  :::{.cell}
   ...
   typcategory is an arbitrary classification of data types that is used by the parser to determine which implicit casts should be "preferred". See Codes.
  :::{/cell}
  :::{/row}
  :::{.row}
  :::{.cell}
  ...
  :::{.row}
  :::{.cell}
   typrelid `oid` (references [pg_class](#catalog-pg-class).oid)
  ...
  :::{.row}
  :::{.cell}
   typsubscript `regproc` (references [pg_proc](#catalog-pg-proc).oid)
  ...
  :::{.row}
  :::{.cell}
   typelem `oid` (references [pg_type](#catalog-pg-type).oid)
  ...
  :::{.row}
  :::{.cell}
   typarray `oid` (references [pg_type](#catalog-pg-type).oid)
  ...
  :::{.row}
  :::{.cell}
   typinput `regproc` (references [pg_proc](#catalog-pg-proc).oid)
  ...
  :::{.row}
  :::{.cell}
   typoutput `regproc` (references [pg_proc](#catalog-pg-proc).oid)
  ...
  :::{.row}
  :::{.cell}
   typreceive `regproc` (references [pg_proc](#catalog-pg-proc).oid)
  ...
  :::{.row}
  :::{.cell}
   typsend `regproc` (references [pg_proc](#catalog-pg-proc).oid)
  ...
  :::{.row}
  :::{.cell}
   typmodin `regproc` (references [pg_proc](#catalog-pg-proc).oid)
  ...
  :::{.row}
  :::{.cell}
   typmodout `regproc` (references [pg_proc](#catalog-pg-proc).oid)
  ...
  :::{.row}
  :::{.cell}
   typanalyze `regproc` (references [pg_proc](#catalog-pg-proc).oid)

   Custom [ANALYZE](braised:ref/sql-analyze) function, or zero to use the standard function
  :::{/cell}
  :::{/row}
  :::{.row}
  :::{.cell}
  ...
  :::{.row}
  :::{.cell}
   typbasetype `oid` (references [pg_type](#catalog-pg-type).oid)
  ...
  :::{.row}
  :::{.cell}
   typcollation `oid` (references [pg_collation](#catalog-pg-collation).oid)
...
Codes lists the system-defined values of typcategory.
