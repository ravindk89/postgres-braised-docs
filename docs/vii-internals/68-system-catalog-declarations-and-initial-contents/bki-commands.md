---
title: "68.4. BKI Commands"
id: bki-commands
---

:::{.dl}
:::{.item term="`create` *tablename* *tableoid* \[`bootstrap`\] \[`shared_relation`\] \[`rowtype_oid` *oid*\] (*name1* = *type1* \[`FORCE NOT NULL` \| `FORCE NULL`\] \[, *name2* = *type2* \[`FORCE NOT NULL` \| `FORCE NULL`\], \...\])"}
...
:::{/item}
:::{.item term="`declare` \[`unique`\] `index` *indexname* *indexoid* `on` *tablename* `using` *amname* `(` *opclass1* *name1* \[, \...\] `)`"}
...
:::{/item}
:::{.item term="`declare toast` *toasttableoid* *toastindexoid* `on` *tablename*"}
