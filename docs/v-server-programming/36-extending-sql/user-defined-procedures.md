---
title: "36.4. User-Defined Procedures"
id: xproc
---
...
Collectively, functions and procedures are also known as routines[`ALTER ROUTINE`](#sql-alterroutine) and [`DROP ROUTINE`](#sql-droproutine) that can operate on functions and procedures without having to know which kind it is.
