---
title: "37.4. A Complete Trigger Example"
id: trigger-example
---
...
There are more complex examples in `src/test/regress/regress.c` and in [F.41. spi — Server Programming Interface features/examples](braised:ref/contrib-spi).
