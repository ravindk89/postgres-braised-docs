---
title: "43.8. PL/Perl Under the Hood"
...
:::{.dl}
:::{.item term="`plperl.on_init` (`string`)"}
...
:::{/item}
:::{.item term="`plperl.use_strict` (`boolean`)"}
