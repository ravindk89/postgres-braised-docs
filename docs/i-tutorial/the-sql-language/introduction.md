...
Numerous books have been written on SQL, including [Understanding the New SQL](#understanding-the-new-sql) and [A Guide to the SQL Standard](#a-guide-to-the-sql-standard).
You should be aware that some PostgreSQL language features are extensions to the standard.
