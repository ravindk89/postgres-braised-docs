...
The functions provided by the `pg_trgm` module are shown in Functions, the operators in Operators.
...
:::{/item}
:::{.item term="`pg_trgm.strict_word_similarity_threshold` (`real`)"}
