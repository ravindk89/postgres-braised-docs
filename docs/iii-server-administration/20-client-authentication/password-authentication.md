---
title: "20.5. Password Authentication"
id: auth-password
---
...
Passwords can be managed with the SQL commands [CREATE ROLE](braised:ref/sql-createrole) and [ALTER ROLE](braised:ref/sql-alterrole), e.g., `CREATE ROLE foo WITH LOGIN PASSWORD 'secret'`, or the psql command `\password`.
