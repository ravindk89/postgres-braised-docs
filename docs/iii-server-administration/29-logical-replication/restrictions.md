...
-   Large objects (see [Large Objects](#large-objects)) are not replicated. There is no workaround for that, other than storing data in normal tables.
