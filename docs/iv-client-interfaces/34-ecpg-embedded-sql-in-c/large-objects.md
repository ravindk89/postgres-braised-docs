...
For more details about the `ECPGget_PGconn()`, see [Library Functions](braised:ref/ecpg-library).
For information about the large object function interface, see [Large Objects](#large-objects).
...
example shows an example program that illustrates how to create, write, and read a large object in an ECPG application.
